Of course. It is my pleasure to provide the final, updated documentation. We have built an incredibly powerful and nuanced tool together, and it deserves a comprehensive guide that captures all of its features and rules.

Here is the documentation in both English and Bahasa Indonesia.
